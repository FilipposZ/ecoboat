	...
	const cards: ICard[] = $state([
		{
			id: 1,
			title: 'Our Mission',
			content: `At ${PUBLIC_PROJECT_NAME}, our mission is to inspire a world where humanity and nature thrive together. By showcasing self-sustaining systems, we aim to ignite hope, education, and action for a greener future.`,
