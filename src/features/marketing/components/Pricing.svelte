...
<Container id="pricing" class="py-24 sm:py-32">
	...
	<div class="flex flex-wrap justify-center gap-10 md:gap-16 w-fit mx-auto">
		<!-- Basic package -->
		<div class="card p-8 w-80 ring-2 ring-base-content/30 shadow-md">
			<h3 class="text-xl font-extrabold mb-2 text-base-content text-opacity-80">Basic</h3>
			<div class="text-5xl font-extrabold leading-snug">€150</div>
			...
			<a class="btn mt-auto" href="/"><Ship /> Book your day</a>
		</div>
		...
		<div class="relative card p-8 w-80 ring-2 ring-primary shadow-xl">
			...
			<h3 class="text-xl font-extrabold mb-2 text-base-content text-opacity-80">With guide</h3>
			<div class="text-5xl font-extrabold leading-snug">€400</div>
			<ul class="space-y-2 mt-3 mb-20">
			...
			<a class="btn btn-primary mt-auto" href="/"><Ship /> Book your day</a>
		</div>
	</div>
</Container>
